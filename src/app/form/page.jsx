        ...
        <Form>
          ...
          <div className="mb-4">
            ...
            <Field
              ...
              id="dob"
              name="dob"
              className="border-gray-300 w-full rounded-md border px-3 py-3 shadow-sm text-lg focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50"
            />
            <ErrorMessage
              name="dob"
              component="p"
              className="text-red mt-1 text-xs italic"
            />
          </div>
